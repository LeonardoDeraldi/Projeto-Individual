...
function autenticar(email, senha) {
    ...
    var instrucaoSql = `
        SELECT idUsuario, nome, email, fkTimes as idTimes FROM usuario WHERE email = '${email}' AND senha = '${senha}';
    `;
...
function cadastrar(nome, email, senha, idTimes) {
...
function registrar(corretas, incorretas, idUsuario) {
    console.log("ACESSEI O USUARIO MODEL \n \n\t\t >> Se aqui der erro de 'Error: connect ECONNREFUSED',\n \t\t >> verifique suas credenciais de acesso ao banco\n \t\t >> e se o servidor de seu BD está rodando corretamente. \n\n function registrar():", corretas, incorretas, idUsuario);
...
function buscaApreencao(idUsuario) {
    console.log("ACESSEI O USUARIO MODEL \n \n\t\t >> Se aqui der erro de 'Error: connect ECONNREFUSED',\n \t\t >> verifique suas credenciais de acesso ao banco\n \t\t >> e se o servidor de seu BD está rodando corretamente. \n\n function buscaApreencao():", idUsuario);
